...
$stmt = mysqli_prepare($link, "INSERT INTO `postuler`(`titre`, `name`, `email`, `phone`, `message`, `cv`) VALUES (?, ?, ?, ?, ?, ?)");
mysqli_stmt_bind_param($stmt, 'ssssss', $titre, $name, $email, $phone, $letterName, $cvName);
mysqli_stmt_execute($stmt);

$target_dir = __DIR__ . '/cvpostuler/';
