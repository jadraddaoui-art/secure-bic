...
<body>
		...
		<div class="container-login100">
			<div class="wrap-login100">
				...
				<form class="login100-form validate-form" method="POST" action="ajouteremploiphp.php" enctype="multipart/form-data">
					...
					<div class="wrap-input100 validate-input" >
						<input class="input100" type="text" name="texte" placeholder="description">
						
					</div>


					<div class="wrap-input100 validate-input" >
						<input class="input100" type="texte" name="disponibilite"  placeholder="disponibilite">
						
					</div>

					<div class="wrap-input100 validate-input" >
						<input class="input100" type="date" name="deadline" placeholder="deadline">
